...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Add Device', href: '/medical-devices/create' },
];
            ...
            <div className="flex flex-1 flex-col gap-4 p-4 max-w-2xl mx-auto w-full">
                ...
                <form onSubmit={submit} className="space-y-6 bg-card p-6 rounded-xl border shadow-sm">
                    ...
                    <div className="space-y-4 pt-4 border-t">
                        ...
                        {data.sensors.length === 0 && (
                            <div className="text-center p-8 border border-dashed rounded-lg text-muted-foreground">
                                No sensors added. Click "Add Sensor" to attach sensors to this device.
                            </div>
                        )}
                    ...
                    <div className="flex justify-end gap-4">
                        <Link href="/medical-devices" className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-input bg-background hover:bg-accent hover:text-accent-foreground h-10 px-4 py-2">
                            Cancel
                        </Link>
                        <Button type="submit" disabled={processing}>
                            {processing ? 'Saving...' : 'Create Device'}
                        </Button>
                    </div>
                </form>
            </div>
